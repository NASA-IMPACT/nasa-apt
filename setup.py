...
extra_reqs = {
    ...
    "deploy": [
        ...
        "aws-cdk.aws_iam>=2.34.2",
        "aws-cdk.aws_rds>=2.34.2",
        "aws-cdk.aws_ssm>=2.34.2",
        "aws-cdk.aws_ec2>=2.34.2",
        "aws-cdk.aws_ecs>=2.34.2",
        "aws-cdk.aws_opensearchservice>=2.34.2",
        "aws-cdk.aws_cognito>=2.34.2",
    ],
    "test": [
        "moto==2.0.8",
        "factory-boy==3.2.0",
