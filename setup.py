...
extra_reqs = {
    ...
    "deploy": [
        ...
        "aws-cdk.aws_lambda>=1.169.0",
        "aws-cdk.aws_apigatewayv2>=1.169.0",
        "aws-cdk.aws_apigatewayv2_integrations>=1.169.0",
        "aws-cdk.aws_iam>=1.169.0",
        "aws-cdk.aws_rds>=1.169.0",
        "aws-cdk.aws_ssm>=1.169.0",
        "aws-cdk.aws_ec2>=1.169.0",
        "aws-cdk.aws_ecs>=1.169.0",
        "aws-cdk.aws_opensearchservice",
        "aws-cdk.aws_cognito>=1.169.0",
    ],
    "test": [
        "moto==2.0.8",
        "factory-boy==3.2.0",
