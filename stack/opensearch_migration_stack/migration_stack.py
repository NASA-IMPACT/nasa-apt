    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if role:
            ...
            es_domain_migration_source_arn = "arn:aws:es:us-east-1:552819999234:domain/t-api-lambda-staging-elastic"

            # see sid for comments
            role.attach_inline_policy(
                iam.Policy(self,'{migration_stackname}-snapshot-policy',
                    statements=[
                        iam.PolicyStatement(
