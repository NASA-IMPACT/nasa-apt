...
curator_sub=$(aws --endpoint-url http://localstack:4566 cognito-idp admin-create-user --user-pool-id ${pool_id} --username curator@example.com --user-attributes '[{"Name":"preferred_username","Value":"Carlos Curator"}, {"Name":"email","Value":"curator@example.com"}]' | jq -rc '.User.Attributes[] | select(.Name=="sub")| .Value')
...
owner_sub=$(aws --endpoint-url http://localstack:4566 cognito-idp admin-create-user --user-pool-id ${pool_id} --username owner@example.com --user-attributes '[{"Name":"preferred_username","Value":"Olivia Owner"}, {"Name":"email","Value":"owner@example.com"}]' | jq -rc '.User.Attributes[] | select(.Name=="sub")| .Value')
...
author_sub_1=$(aws --endpoint-url http://localstack:4566 cognito-idp admin-create-user --user-pool-id ${pool_id} --username author1@example.com --user-attributes '[{"Name":"preferred_username","Value":"Andre Author"}, {"Name":"email","Value":"author1@example.com"}]' | jq -rc '.User.Attributes[] | select(.Name=="sub")| .Value')
...
author_sub_2=$(aws --endpoint-url http://localstack:4566 cognito-idp admin-create-user --user-pool-id ${pool_id} --username author2@example.com --user-attributes '[{"Name":"preferred_username","Value":"Anita Author"}, {"Name":"email","Value":"author2@example.com"}]' | jq -rc '.User.Attributes[] | select(.Name=="sub")| .Value')
...
author_sub_3=$(aws --endpoint-url http://localstack:4566 cognito-idp admin-create-user --user-pool-id ${pool_id} --username author3@example.com --user-attributes '[{"Name":"preferred_username","Value":"Allison Author"}, {"Name":"email","Value":"author3@example.com"}]' | jq -rc '.User.Attributes[] | select(.Name=="sub")| .Value')
...
reviewer_sub_1=$(aws --endpoint-url http://localstack:4566 cognito-idp admin-create-user --user-pool-id ${pool_id} --username reviewer1@example.com --user-attributes '[{"Name":"preferred_username","Value":"Ricardo Reviewer"}, {"Name":"email","Value":"reviewer1@example.com"}]' | jq -rc '.User.Attributes[] | select(.Name=="sub")| .Value')
...
reviewer_sub_2=$(aws --endpoint-url http://localstack:4566 cognito-idp admin-create-user --user-pool-id ${pool_id} --username reviewer2@example.com --user-attributes '[{"Name":"preferred_username","Value":"Ronald Reviewer"}, {"Name":"email","Value":"reviewer2@example.com"}]' | jq -rc '.User.Attributes[] | select(.Name=="sub")| .Value')
...
reviewer_sub_3=$(aws --endpoint-url http://localstack:4566 cognito-idp admin-create-user --user-pool-id ${pool_id} --username reviewer3@example.com --user-attributes '[{"Name":"preferred_username","Value":"Rita Reviewer"}, {"Name":"email","Value":"reviewer3@example.com"}]' | jq -rc '.User.Attributes[] | select(.Name=="sub")| .Value')
