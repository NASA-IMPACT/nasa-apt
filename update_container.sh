...
aws ecs update-service --force-new-deployment --cluster nasa-apt-samltest2-ECSCluster-4EbHcIESsbQD --service nasa-apt-samltest2-svc-fastapi --region us-east-1
